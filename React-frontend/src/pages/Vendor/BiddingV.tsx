...
function getTags(opp: Opportunity): string[] {
    const raw = (opp.technical_requirements || opp.description || '').replace(/<[^>]*>/g, ' ');
        ...
        return (
            <div className="h-full flex flex-col font-gantari animate-in fade-in duration-300">
                <div className="flex items-center gap-4 mb-8 shrink-0">
                    <button onClick={closeDetail} className="p-2 border-none bg-[#F2F2F2] rounded-md transition-opacity">
                        <img src={backIcon} alt="back" className="w-5 h-5" />
                    </button>
                    <div>
                        <h2 className="text-[24px] font-medium text-[#000000] font-gantari">{detailOpp.project_name}</h2>
                        <div className="flex items-center gap-2 mt-1">
                            <span className={`px-2.5 py-1 rounded-md text-[12px] font-medium font-gantari ${detailOpp.status === 'active' ? 'bg-[#E8F9E8] text-[#16A34A]' : 'bg-[#FFE5E5] text-[#DE3D3A]'}`}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-white border border-[#EBEBEB] rounded-2xl p-6 shadow-sm">
                                <h3 className="text-[20px] font-medium text-[#353535] mb-4 border-b-[1.5px] border-[#F2F2F2] pb-2 font-gantari">Project Overview</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari">Bidding Budget</span>
                                        <span className="text-[18px] font-bold text-[#DE3D3A] font-gantari">{formatBudget(detailOpp.budget_ceiling || detailOpp.outsource_budget)}</span>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari">Submission Deadline</span>
                                        <span className="text-[14px] font-medium text-[#353535] font-gantari">{detailOpp.bid_deadline ? new Date(detailOpp.bid_deadline).toLocaleDateString('en-GB', { day: '2-digit', month: 'long', year: 'numeric' }) : '—'}</span>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari">Competition Level</span>
                                        <span className="text-[14px] font-medium text-[#353535] font-gantari">{detailOpp.bids_count ?? 0} Bids Submitted</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Description Section */}
                            <div className="bg-white border border-[#EBEBEB] rounded-2xl p-6 shadow-sm">
                                <h3 className="text-[20px] font-medium text-[#353535] mb-4 border-b-[1.5px] border-[#F2F2F2] pb-2 font-gantari">Description</h3>
                            ...
                            <div className="bg-white border border-[#EBEBEB] rounded-2xl p-6 shadow-sm">
                                <h3 className="text-[20px] font-medium text-[#353535] mb-4 border-b-[1.5px] border-[#F2F2F2] pb-2 font-gantari">Technical Requirements</h3>
                                <div className="text-[#8B8B8B] leading-relaxed whitespace-pre-wrap text-[14px] font-gantari">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white border border-[#EBEBEB] rounded-2xl p-6 shadow-sm">
                                <h3 className="text-[20px] font-medium text-[#353535] mb-4 border-b-[1.5px] border-[#F2F2F2] pb-2 font-gantari">Submission Status</h3>
                                {detailOpp.already_bid || bidSuccess === detailOpp.id ? (
                                    <div className="bg-[#EAFDF5] border border-[#16A34A]/20 rounded-xl p-4 mb-4 text-[#16A34A]">
                                        ...
                                        <p className="text-[12px] text-[#16A34A]/80 italic font-gantari">Your proposal is currently under review by the host organization.</p>
                                    </div>
                                ) : detailOpp.status === 'active' ? (
                                    <div className="space-y-4">
                                        <p className="text-[14px] text-[#8B8B8B] font-gantari">Submit your technical proposal and commercial bid to participate in this opportunity.</p>
                                        <button
                                    ...
                                    <div className="bg-[#F9F9F9] border border-[#EBEBEB] rounded-xl p-4 text-center">
                                        <p className="text-[12px] font-bold text-[#AEACAC] uppercase tracking-widest font-gantari">Bidding Closed</p>
                                    </div>
                                )}
                            </div>
                            ...
                            {/* Tags Card */}
                            <div className="bg-white border border-[#EBEBEB] rounded-2xl p-6 shadow-sm">
                                <h3 className="text-[20px] font-medium text-[#353535] mb-4 border-b-[1.5px] border-[#F2F2F2] pb-2 font-gantari">Area of Expertise</h3>
                                <div className="flex flex-wrap gap-2">
                                    {getTags(detailOpp).map((tag, i) => (
                                        <span key={i} className="px-3 py-1 bg-[#F2F2F2] text-[#353535] text-[14px] font-bold rounded-lg uppercase tracking-wide font-gantari">{tag}</span>
                                    ))}
                                    {getTags(detailOpp).length === 0 && <span className="text-[#8B8B8B] text-[14px] font-gantari">No specific tags identified.</span>}
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        return (
             <div className="h-full flex flex-col font-gantari animate-in fade-in duration-300">
                <div className="flex items-center gap-4 mb-8 shrink-0">
                    ...
                    <div>
                        <h2 className="text-[24px] font-medium text-[#000000] font-gantari">{detailBid.project_name || `Bid Submission #${detailBid.id}`}</h2>
                        <div className="flex items-center gap-2 mt-1">
                            <span className={`px-2.5 py-1 rounded-full text-[12px] font-medium font-gantari ${getStatusBadge(detailBid.status)}`}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-white border border-[#EBEBEB] rounded-md p-6 shadow-sm">
                                <h3 className="text-[20px] font-medium text-[#353535] mb-4 border-b-[1.5px] border-[#F2F2F2] pb-3 font-gantari">Financial Breakdown</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="flex flex-col gap-1 p-4 bg-[#F8F8F8] rounded-md">
                                        <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari uppercase tracking-wider">Your Submitted Bid</span>
                                        <span className="text-[24px] font-bold text-[#DE3D3A] font-gantari">{formatBudget(detailBid.bid_amount)}</span>
                                    </div>
                                    <div className="flex flex-col gap-1 p-4 border-[1.5px] border-[#F2F2F2] rounded-md">
                                        <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari uppercase tracking-wider">Project Budget Ceiling</span>
                                        <span className="text-[24px] font-bold text-[#353535] font-gantari">{formatBudget(detailBid.outsource_budget || 0)}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Proposal Details */}
                            <div className="bg-white border border-[#EBEBEB] rounded-md p-6 shadow-sm">
                                <h3 className="text-[20px] font-medium text-[#353535] mb-4 border-b-[1.5px] border-[#F2F2F2] pb-3 font-gantari">Submission Details</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari">Proposed Timeline</span>
                                        <span className="text-[14px] font-medium text-[#353535] font-gantari">{detailBid.timeline || 'Not specified'}</span>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari">Allocated Team Size</span>
                                        <span className="text-[14px] font-medium text-[#353535] font-gantari">{detailBid.team_size ? `${detailBid.team_size} Members` : 'N/A'}</span>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari">Original Bid Deadline</span>
                                        <span className="text-[14px] font-medium text-[#353535] font-gantari">{detailBid.bid_deadline ? new Date(detailBid.bid_deadline).toLocaleDateString() : '—'}</span>
                                    </div>
                                    <div className="flex flex-col gap-1">
                                        <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari">Submission Timestamp</span>
                                        <span className="text-[14px] font-medium text-[#353535] font-gantari">{detailBid.created_at ? new Date(detailBid.created_at).toLocaleString() : '—'}</span>
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <span className="text-[#8B8B8B] text-[14px] font-medium font-gantari uppercase tracking-wider">Proposal Notes / Approach</span>
                        ...
                        <div className="space-y-6">
                            <div className="bg-white border border-[#EBEBEB] rounded-md p-6 shadow-sm">
                                <h3 className="text-[20px] font-medium text-[#353535] mb-4 border-b-[1.5px] border-[#F2F2F2] pb-3 font-gantari">Decision Status</h3>
                                <div className="flex flex-col items-center justify-center py-6 text-center">
                                    ...
                                    <h4 className="text-[20px] font-bold text-[#353535] font-gantari">{getStatusLabel(detailBid.status)}</h4>
    ...
    return (
        <div className="h-full flex flex-col font-gantari bg-white p-2 overflow-hidden">
            <div className="flex items-center justify-between mb-6 shrink-0 px-2">
                <h2 className="text-[24px] font-medium text-[#000000]">{mainTab === 'opportunities' ? 'Bidding Console' : 'My Submissions'}</h2>
                ...
                <div className="flex items-center gap-3">
                    ...
                    {mainTab === 'opportunities' && (
                        <div className="relative">
                            ...
                            >
                                <span>Bid Status{oppTab !== 'all' ? `: ` : ''}<span className="font-semibold">{oppTab !== 'all' ? (oppTab === 'active' ? 'Active' : oppTab === 'bid' ? 'Bid Submitted' : 'Closed') : ''}</span></span>
                                ...
                                <>
                                    ...
                                    <div className="absolute top-full right-0 mt-2 w-56 bg-white border border-[#E5E5E5] rounded-xl shadow-xl z-20 py-0 overflow-hidden animate-in fade-in slide-in-from-top-1 duration-200">
                                        {[
                                            ...
                                            <button
                                                key={tab.key}
                                                onClick={() => { setOppTab(tab.key); setStatusDropdownOpen(false); }}
                    ...
                    {mainTab === 'my-bids' && (
                        <div className="relative">
                            ...
                            >
                                {showEntries === 'show' ? (
                                    <span className="text-sm font-medium text-[#616161]">Show</span>
                                ) : (
                                    <span className="text-sm font-medium text-[#353535]">Show: {showEntries === '1-500' ? 'All' : showEntries}</span>
                                )}
                                <img 
                                    src={ArrowDown} 
                                    alt="arrow" 
                            ...
                            {showDropdownOpen && (
                                <>
                                    <div className="fixed inset-0 z-10" onClick={() => setShowDropdownOpen(false)} />
                                    <div className="absolute top-full right-0 mt-1 z-50 bg-white border border-gray-200 rounded-lg shadow-lg min-w-[120px] py-0 max-h-[160px] overflow-y-auto custom-scrollbar">
                                        ...
                                        {[
                                            ...
                                            <button
                                                key={opt.val}
                                                onClick={() => { setShowEntries(opt.val); setShowDropdownOpen(false); }}
            ...
            {mainTab === 'opportunities' && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 shrink-0">
                    {kpiCards.map((card, i) => (
                        <div key={i} className="bg-[#F2F2F2] group hover:bg-[#DD4342] rounded-md border border-[#AEACAC52] px-4 py-4 shadow-sm flex items-center justify-between min-h-0 transition-colors">
                            <h3 className="text-[18px] text-[#353535] group-hover:text-[#F2F2F2] font-medium font-gantari">{card.label}</h3>
                        ...
                        {filteredOpps.length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 pb-4">
                                {filteredOpps.map(opp => {
                                    ...
                                    return (
                                        <div key={opp.id} className="bg-white border border-[#EBEBEB] rounded-xl p-5 flex flex-col h-full shadow-sm hover:shadow-md transition-shadow">
                                            <div className="flex items-center gap-3 mb-3 min-h-[50px]">
                                                <div className="w-10 h-10 rounded-lg flex items-center justify-center text-[15px] font-bold shrink-0 bg-[#F2F2F2]" style={{ color: avatarBg }}>
                                                    {initials}
                                                </div>
                                                <div className="min-w-0">
                                                    <p className="text-[18px] font-medium text-[#353535] truncate leading-tight">{name}</p>
                                            ...
                                            <div className="flex items-center justify-between text-[14px] text-[#717171] mb-2">
                                                ...
                                                <span className={`shrink-0 text-[14px] font-medium px-2 py-0.5 rounded-md ${isActive ? 'bg-[#E8F9E8] text-[#16A34A]' : 'bg-[#FFE5E5] text-[#DE3D3A]'}`}>
                                            ...
                                            <div className="border-t border-[#F0F0F0] pt-3 mb-2">
                                                <div className="flex items-center justify-between">
                                                    <p className="text-[18px] font-bold text-[#353535]">{formatBudget(opp.budget_ceiling || opp.outsource_budget)}</p>
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="flex-1">
                                                    {alreadyBid ? (
                                                        ...
                                                        <span className="text-[14px] text-[#DE3D3A] font-medium">Closed</span>
                                                    )}
                                                </div>
                            ...
                            {filteredBids.length === 0 ? (
                                ...
                                <table className="min-w-full border-collapse font-gantari">
                                    <thead className="sticky top-0 z-10 bg-white after:content-[''] after:absolute after:left-2 after:right-2 after:bottom-0 after:h-[1.5px] after:bg-[rgb(89,89,89)]/10">
                                        <tr className="">
                                            <th className="px-4 py-4 text-center text-[16px] font-medium text-[#353535] font-gantari whitespace-nowrap">Sl.No</th>
                                            <th className="px-4 py-4 text-center text-[16px] font-medium text-[#353535] font-gantari whitespace-nowrap">Project Name</th>
                                            <th className="px-4 py-4 text-center text-[16px] font-medium text-[#353535] font-gantari whitespace-nowrap">Bid Amount</th>
                                            <th className="px-4 py-4 text-center text-[16px] font-medium text-[#353535] font-gantari whitespace-nowrap">Outsource Budget</th>
                                            <th className="px-4 py-4 text-center text-[16px] font-medium text-[#353535] font-gantari whitespace-nowrap">Submitted On</th>
                                            <th className="px-4 py-4 text-center text-[16px] font-medium text-[#353535] font-gantari whitespace-nowrap">Status</th>
                                            <th className="px-4 py-4 text-center text-[16px] font-medium text-[#353535] font-gantari whitespace-nowrap">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-gray-50">
                                        {filteredBids.map((bid, idx) => (
                                            <tr key={bid.id} className={`${idx % 2 === 1 ? 'bg-[#F2F2F2]' : 'bg-white'}`}>
                                                <td className="px-4 py-6 text-center text-[14px] font-medium text-[#353535] font-gantari whitespace-nowrap">{idx + 1}</td>
                                                <td className="px-4 py-6 text-center">
                                                    <p className="text-[14px] font-medium text-[#353535] font-gantari whitespace-nowrap">{bid.project_name || `Opportunity #${bid.opportunity_id}`}</p>
                                                </td>
                                                <td className="px-4 py-6 text-center text-[14px] font-medium text-[#DE3D3A] font-gantari whitespace-nowrap">{formatBudget(bid.bid_amount)}</td>
                                                <td className="px-4 py-6 text-center text-[14px] font-medium text-[#353535] font-gantari whitespace-nowrap">{formatBudget(bid.outsource_budget || 0)}</td>
                                                <td className="px-4 py-6 text-center text-[14px] font-medium text-[#353535] font-gantari whitespace-nowrap">{bid.created_at ? new Date(bid.created_at).toLocaleDateString() : '—'}</td>
                                                <td className="px-4 py-6 text-center">
                                                    <span className={`px-3 py-1 rounded-lg text-[14px] font-medium font-gantari ${getStatusBadge(bid.status)} whitespace-nowrap`}>{getStatusLabel(bid.status)}</span>
                                                </td>
                                                <td className="px-4 py-6 text-center">
