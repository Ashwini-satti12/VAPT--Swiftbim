...
import Login from './pages/ProjectManager/Login';
import ClientLogin from './pages/ProjectManager/ClientLogin';
import Dashboard from './pages/ProjectManager/Dashboard';
import Employees from './pages/ProjectManager/Employees';
import Clients from './pages/ProjectManager/Clients';
...
import ClientDetail from './pages/ProjectManager/ClientDetail';
import ClientDashboard from './pages/ProjectManager/ClientDashboard';
import ClientProjectDetail from './pages/ProjectManager/ClientProjectDetail';
import ClientMilestones from './pages/ProjectManager/ClientMilestones';
import ClientChat from './pages/ProjectManager/ClientChat';
import './App.css';
