                        ...
                        <div className="space-y-4">
                          {projectTasks.map((task) => {
                            ...
                            const startLabel = hasStart
                              ? formatTimeStringToAMPM(effStart)
                              : "—";
                            const endLabel = hasEnd
                              ? formatTimeStringToAMPM(effEnd)
                              : "—";
          ...
          <div className="bg-white rounded-md border border-[#AEACAC52] pl-4 pb-4 pr-0 shadow-sm flex flex-col h-full min-h-0">
            ...
            <div className="flex flex-nowrap items-center justify-center gap-2 sm:gap-4 mb-3 px-2 shrink-0">
              <button
                type="button"
                onClick={goPrevMonth}
                className="p-1.5 rounded cursor-pointer text-slate-600 hover:bg-slate-100 hover:text-black transition-colors cursor-pointer"
