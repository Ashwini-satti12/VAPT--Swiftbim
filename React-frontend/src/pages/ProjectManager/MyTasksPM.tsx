                  ...
                  <div className="flex flex-wrap gap-2">
                    <div className="flex flex-1 min-w-0">
                      <input
                        ...
                        className="flex-1 rounded-l-sm rounded-r-none bg-[#F2F3F4] px-3 py-2 text-[14px] text-[#353535] placeholder-[#8B8B8B] border border-transparent focus:outline-none focus:border-[#AEACAC52] focus:ring-1 focus:ring-[#AEACAC52] transition-all truncate"
                        title={
                          attachmentFiles.length > 0
                            ? attachmentFiles.map((f) => f.name).join(", ")
                            : undefined
