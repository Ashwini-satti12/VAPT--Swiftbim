            ...
            <div className="flex-shrink-0 mb-6 flex flex-row items-center justify-between gap-4 flex-wrap">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="relative" ref={employeeDropdownRef}>
                        ...
                        >
                            <span className='text-[17px]'>Employee:</span>
                                ...
                                {employeeOptions.map((name) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full text-left px-4 py-2.5 text-[17px] font-medium transition-colors truncate ${isSelected ? 'text-[#353535] bg-[#F0F2F7]' : 'text-[#616161] hover:text-[#353535] hover:bg-[#F8F9FA]'}`}
                                        >
                                            {name}
                                        </button>
                                    );
                    ...
                    <table className="min-w-full border-collapse">
                        <thead className="sticky top-0 z-10 bg-[#FFFFFF] relative after:content-[''] after:absolute after:left-2 after:right-2 after:bottom-0 after:h-[1px] after:bg-[rgb(89,89,89)]/20">
                            <tr className="bg-[#FFFFFF]">
                                <th className="px-3 py-4 text-center text-[18px] font-semibold text-[#353535] bg-[#FFFFFF] font-gantari whitespace-nowrap">Sl.No</th>
                                <th className="px-3 py-4 text-center text-[18px] font-semibold text-[#353535] bg-[#FFFFFF] font-gantari whitespace-nowrap">Employee Name</th>
                                <th className="px-3 py-4 text-center text-[18px] font-semibold text-[#353535] bg-[#FFFFFF] font-gantari whitespace-nowrap">Role</th>
                                <th className="px-3 py-4 text-center text-[18px] font-semibold text-[#353535] bg-[#FFFFFF] font-gantari whitespace-nowrap">Leave Type</th>
                                <th className="px-3 py-4 text-center text-[18px] font-semibold text-[#353535] bg-[#FFFFFF] font-gantari whitespace-nowrap">From Date</th>
                                <th className="px-3 py-4 text-center text-[18px] font-semibold text-[#353535] bg-[#FFFFFF] font-gantari whitespace-nowrap">To Date</th>
                                <th className="px-3 py-4 text-center text-[18px] font-semibold text-[#353535] bg-[#FFFFFF] font-gantari whitespace-nowrap">Status</th>
                                <th className="px-3 py-4 text-center text-[18px] font-semibold text-[#353535] bg-[#FFFFFF] font-gantari whitespace-nowrap">Action</th>
                            </tr>
                        </thead>
                            ...
                            {displayedList.length === 0 ? (
                                ...
                                displayedList.map((row: LeaveEntry, index: number) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <td className="px-3 py-6 text-center text-[17px] text-[#353535] font-medium font-gantari whitespace-nowrap align-middle">{slNoDisplay}</td>
                                            <td className="px-3 py-6 text-center text-[17px] text-[#353535] font-semibold font-gantari whitespace-nowrap align-middle">{row.employeeName}</td>
                                            <td className="px-3 py-6 text-center text-[17px] text-[#353535] font-gantari whitespace-nowrap align-middle">{row.role ?? '–'}</td>
                                            <td className="px-3 py-6 text-center text-[17px] text-[#353535] font-gantari whitespace-nowrap align-middle">{row.leaveType}</td>
                                            <td className="px-3 py-6 text-center text-[17px] text-[#353535] font-gantari whitespace-nowrap align-middle">{row.fromDate ?? '–'}</td>
                                            <td className="px-3 py-6 text-center text-[17px] text-[#353535] font-gantari whitespace-nowrap align-middle">{row.toDate ?? '–'}</td>
                                            <td className="px-3 py-6 text-center whitespace-nowrap align-middle">
                                                <span className={`inline-flex px-4 py-1.5 rounded-lg text-[17px] font-bold font-gantari ${row.currentStatus === 'Approved' ? 'bg-[#E1F6EB] text-[#008F22]' : row.currentStatus === 'Rejected' ? 'bg-[#FFE5E5] text-[#C62828]' : 'bg-[#FFF8E1] text-[#F57C00]'}`}>
                                                    {row.currentStatus}
                                                </span>
                                            </td>
                                            <td className="px-3 py-6 text-center whitespace-nowrap align-middle">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                setLeaveFrom(v);
                                                if (applyFormErrors.leaveFrom) setApplyFormErrors((p) => ({ ...p, leaveFrom: '' }));
                                                if (applyFormErrors.leaveTo && leaveTo && v && v <= leaveTo) setApplyFormErrors((p) => ({ ...p, leaveTo: '' }));
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (applyFormErrors.leaveTo) setApplyFormErrors((p) => ({ ...p, leaveTo: '' }));
                                            }}
