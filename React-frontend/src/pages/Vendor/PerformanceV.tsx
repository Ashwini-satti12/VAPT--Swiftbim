    ...
    return (
        <div className="h-full flex flex-col">
            <div className="flex items-center justify-between mb-5 shrink-0">
                <div>
                    <h1 className="text-xl font-medium font-gantari text-slate-800">Performance & Ratings</h1>
                    <p className="text-xs text-[#717171] font-gantari mt-0.5">Read-only overview of your past project ratings</p>
                </div>
                ...
                <div className="bg-white border border-[#EBEBEB] rounded-xl p-6">
                    {total === 0 ? (
                        <div className="text-center py-8">
                            ...
                            <p className="text-base font-semibold font-gantari text-[#353535] mb-1">No ratings yet</p>
                            <p className="text-sm text-[#717171] font-gantari">Your performance ratings will appear here after project completion reviews.</p>
                        </div>
                    ) : (
