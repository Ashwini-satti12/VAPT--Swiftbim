      ...
      .then(({ data }) => {
        ...
        const mapped: TimesheetEntry[] = tasks.map((t) => {
          ...
          const startDisplay = formatDateDisplay(
            start || t.start_date || t.date || t.due_date,
          );
          const endDisplay = formatDateDisplay(
            end || t.end_date || t.due_date || t.start_date || t.date,
          );
          const taskDateYmd =
            toYmd(t.start_date) ||
            toYmd(t.end_date) ||
      ...
      <div className="flex flex-col gap-4 flex-shrink-0 px-2">
        ...
        <div className="flex flex-wrap items-right justify-end gap-3">
          ...
          <div className="relative min-w-[130px]" ref={employeeDropdownRef}>
            ...
            >
              <span
                className={`text-[14px] font-medium font-gantari ${employee !== "All" ? "text-[#353535]" : "text-[#616161]"}`}
              >
          ...
          <div className="relative min-w-[100px]" ref={teamDropdownRef}>
            ...
            >
              <span
                className={`text-sm font-medium font-gantari ${team !== "All" ? "text-[#353535]" : "text-[#616161]"}`}
              >
                {team === "All" ? "Team" : team}
              </span>
              <img
          ...
          <table className="min-w-full border-collapse">
            <thead className="relative after:content-[''] after:absolute after:left-2 after:right-2 after:bottom-0 after:h-[1px] after:bg-[rgb(89,89,89)]/20">
              <tr className="border-b border-gray-100 bg-white">
                ...
                <th className="px-3 py-4 text-center text-base font-bold text-[#353535] bg-white font-gantari">
                  Task Name
                </th>
                <th className="px-3 py-4 text-center text-base font-bold text-[#353535] bg-white font-gantari whitespace-nowrap">
                  Start Date
            ...
            <tbody className="divide-y divide-gray-50">
              {displayedList.length === 0 ? (
                <tr>
                  <td
                    colSpan={6}
                    className="px-3 py-20 text-center text-[#616161] font-medium font-gantari bg-white"
                  >
                    No records found
                  </td>
                </tr>
                ...
                displayedList.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-3 py-6 text-center text-sm text-[#353535] font-semibold font-gantari whitespace-nowrap align-middle">
                        {row.project_name && row.project_name.trim() !== ""
                          ? row.project_name
                          : "-"}
                      </td>
