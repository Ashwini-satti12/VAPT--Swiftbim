    ...
    <div className="px-0 pt-2 pb-6 space-y-8 flex flex-col h-full bg-white">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-end gap-4 flex-shrink-0 px-2">
        <div className="flex flex-wrap items-center gap-3">
          {/* Start Date */}
          <div className="relative flex items-center justify-between gap-3 px-4 py-2 bg-[#F2F2F2] rounded-md transition-all cursor-pointer group min-w-[130px]">
            <span
              className={`text-[14px] font-medium ${startDate ? "text-[#353535]" : "text-[#616161]"}`}
            >
              {startDate
          ...
          <div className="relative flex items-center justify-between gap-3 px-4 py-2 bg-[#F2F2F2] rounded-md transition-all cursor-pointer group min-w-[130px]">
            <span
              className={`text-[14px] font-medium ${endDate ? "text-[#353535]" : "text-[#616161]"}`}
            >
