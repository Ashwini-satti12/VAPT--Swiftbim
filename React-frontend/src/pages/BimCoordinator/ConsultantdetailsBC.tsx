...
export default function ConsultantdetailsBC() {
    ...
    return (
        <div className="space-y-4">
            <Link to="/bc/consultants" className="group relative w-fit p-2 bg-[#F2F2F2] rounded-md text-[#3d3399] hover:underline text-[14px] flex items-center gap-2 font-medium cursor-pointer transition-all">
