...
import CreateProposalV from "./pages/Vendor/CreateProposalV";
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            />
            <Route
              path="client/projects/:id/milestones"
          ...
          >
            ...
            <Route
              path="td/consultants/:id"
              element={<ConsultantdetailsTD />}
            />
            ...
            <Route
              path="bl/consultants/:id/edit"
              element={<EditConsultantBL />}
            />
            <Route
              path="bl/consultants/:id"
              element={<ConsultantdetailsBL />}
            />
            ...
            <Route
              path="bc/consultants/edit/:id"
              element={<EditConsultantBC />}
            />
            <Route
              path="bc/consultants/:id"
              element={<ConsultantdetailsBC />}
            />
            ...
            <Route
              path="vendor-bim-lead/dashboard"
              element={<VendorBimLeadDashboard />}
            />
            <Route
              path="vendor-bim-lead/projects"
              element={<VendorBimLeadProjects />}
            />
            <Route
              path="vendor-bim-lead/tasks"
              element={<VendorBimLeadTasks />}
            />
            <Route
              path="vendor-bim-lead/opportunities"
              element={<BiddingV />}
            />
            <Route path="vendor-bim-lead/mybids" element={<BiddingV />} />
            <Route
              path="vendor-bim-lead/createteam"
              element={<VendorBimLeadCreateTeam />}
            />
            <Route path="vendor-bim-lead/resources" element={<ResourcesV />} />
            <Route
              path="vendor-bim-lead/communication"
              element={<VendorBimLeadCommunication />}
            />
            <Route
              path="vendor-bim-lead/teamtasks"
              element={<VendorBimLeadTeamTasks />}
            />
            <Route
