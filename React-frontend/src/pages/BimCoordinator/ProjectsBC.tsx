                              ...
                              {canEdit && (
                                <button
                                  onClick={() => {
                                    ...
                                    const mods = (p.module_name || '').split(',').map((s: string) => s.trim()).filter(Boolean);
                                    setEditModuleTags(mods);
                                    setEditModuleInput('');

                                    const mems = (p.member || '').split(',').map((s: string) => s.trim()).filter(Boolean);
                                    ...
                                    // Initialize tags correctly
                                    // fixed
                                    // const mods = (p.module_name || p.modules || '').split(',').map(s => s.trim()).filter(Boolean);
                                    // fixed
                                    // setEditModuleTags(mods);
                                    // setEditModuleInput('');

                                    // fixed
                                    // const mems = (p.member || p.members || '').split(',').map(s => s.trim()).filter(Boolean);
                                    // fixed
                                    // setEditMemberTags(mems);
                                    // setEditMemberInput('');
