...
export default function ProjectsPMV() {
  ...
  const fetchProjects = (status?: string | null) => {
    ...
    Promise.all([
      ...
      api.get<{ tasks?: Array<{ projectid?: number; project_id?: number }> }>(
    ...
    api
      ...
      .then(({ data }) => {
        ...
        setTaskStats({
          ...
          completed: Number(c.completed ?? data.completed_tasks ?? 0),
        });
      ...
      .then(async ({ data }) => {
        if (data.success) {
          ...
          if (createFile && newProjectId) {
            ...
            try {
              await api.post(
                `/api/vendors/vendor-projects/${newProjectId}/upload-document`,
                formData,
                {
  ...
  const openEdit = (p: Project) => {
    ...
    setCreateClientName(
      getClientNameById(p.client_name) ||
    ...
    <div className="space-y-2">
      ...
      <div className="relative dropdown-container">
        <button
          type="button"
          onClick={() =>
            setEditDropdownOpen((o) => (o === "members" ? null : "members"))
          }
            ...
            {selectedMemberIds.length > 0 ? (
              selectedMemberIds.map((id) => {
                ...
                return (
                  <span
                    key={id}
                    className="flex items-center gap-1.5 px-2.5 py-1 bg-white border border-[#DD4342]/20 text-[#DD4342] text-xs font-bold rounded-lg shadow-sm"
                  >
                    {emp?.full_name || `ID: ${id}`}
                    <div
                      onClick={(e) => {
            ...
            {vendorResourceProfiles.map((emp) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-bold ${selectedMemberIds.includes(emp.id) ? "bg-[#DD4342] text-white" : "bg-slate-200 text-slate-500"}`}
                  >
                    {(emp.full_name || "?")[0]}
                  </div>
    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 text-left">
        <div className={`space-y-2 ${showEditModal ? "md:col-span-2" : ""}`}>
          <label className="block text-[14px] font-medium text-[#353535]">
            Project Name <span className="text-[#DD4342]">*</span>
          </label>
          <input
            type="text"
            className="w-full px-5 py-3.5 bg-[#F4F5F7] border-none rounded-[5px] focus:ring-2 focus:ring-[#DD4342]/10 transition-all  text-gray-700 placeholder-gray-400"
        ...
        <div className="space-y-2">
          ...
          <div
            className={`relative dropdown-container ${editDropdownOpen === "pm" ? "z-[60]" : "z-10"}`}
          >
            <button
              type="button"
              onClick={() =>
            ...
            >
              <span
                className={
                  createProjectManager ? "text-gray-700" : "text-gray-400"
                }
              >
            ...
            {editDropdownOpen === "pm" && (
              <div className="absolute top-full left-0 right-0 z-50 mt-1 rounded-[5px] bg-white border border-slate-200 shadow-lg py-1 max-h-48 overflow-y-auto">
                <button
                  ...
                  className="block w-full text-left px-5 py-2.5 text-sm text-gray-700 hover:bg-[#F4F5F7] cursor-pointer"
                >
                ...
                {projectManagers.map((pm) => (
                  <button
                    ...
                    className={`block w-full text-left px-5 py-2.5 text-sm hover:bg-[#F4F5F7] cursor-pointer ${createProjectManager === pm.full_name ? "bg-[#FFF1F1] text-[#DD4342]" : "text-gray-700"}`}
                  >
                    {pm.full_name}
                  </button>
                ))}
        ...
        <div className="space-y-2">
          ...
          <div
            className={`relative dropdown-container ${editDropdownOpen === "bimLead" ? "z-[60]" : "z-10"}`}
          >
            <button
              type="button"
              onClick={() =>
            ...
            >
              <span
                className={createBIMLead ? "text-gray-700" : "text-gray-400"}
              >
              ...
              <div className="absolute top-full left-0 right-0 z-50 mt-1 rounded-[5px] bg-white border border-slate-200 shadow-lg py-1 max-h-48 overflow-y-auto">
                ...
                {bimLeads.map((lead) => (
                  <button
                    ...
                    className={`block w-full text-left px-5 py-2.5 text-sm hover:bg-[#F4F5F7] cursor-pointer ${createBIMLead === lead.full_name ? "bg-[#FFF1F1] text-[#DD4342]" : "text-gray-700"}`}
                  >
                    {lead.full_name}
                  </button>
                ))}
        ...
        <div className="space-y-2">
          <label className="block text-[14px] font-medium text-[#000000]">
        ...
        <div className="space-y-2">
          ...
          <input
            type="date"
            className="w-full px-5 py-3.5 bg-[#F4F5F7] border-none rounded-[5px] focus:ring-2 focus:ring-[#DD4342]/10 transition-all font-medium text[#8B8B8B]"
            value={createEndDate}
        ...
        <div className="space-y-2">
          ...
          <div
            className={`relative dropdown-container ${editDropdownOpen === "priority" ? "z-[60]" : "z-10"}`}
          >
            <button
              type="button"
              onClick={() =>
            ...
            >
              <span
                className={createPriority ? "text-gray-700" : "text-gray-400"}
              >
              ...
              <div className="absolute top-full left-0 right-0 z-50 mt-1 rounded-[5px] bg-white border border-slate-200 shadow-lg py-1 max-h-48 overflow-y-auto">
                {["High", "Medium", "Low"].map((p) => (
                  <button
                    ...
                    className={`block w-full text-left px-5 py-2.5 text-sm hover:bg-[#F4F5F7] cursor-pointer ${createPriority === p ? "bg-[#FFF1F1] text-[#DD4342]" : "text-gray-700"}`}
                  >
                    {p}
                  </button>
                ))}
      ...
      <div className="space-y-6 mt-6 text-left">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-5 py-3.5 bg-[#F4F5F7] border-none rounded-[5px] focus:ring-2 focus:ring-[#DD4342]/10 transition-all font-medium text-gray-700 resize-none placeholder-gray-400"
            ...
            >
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p className="mb-1 text-sm text-slate-500 group-hover:text-slate-600">
                  <span className="font-bold">Add new file</span> or drag and
                  drop
                </p>
            ...
            <div className="relative flex items-center justify-center px-6 py-6 md:px-10 md:py-8 border-b border-slate-50">
              ...
              <div className="text-center min-w-0">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <p className="text-[14px] font-Gantari font-semibold text-[#353535]">
                        ...
                        return (
                          ...
                          >
                            <div className="flex justify-between items-start">
                              <h5
                                className="text-[18px] font-Gantari font-bold text-[#1A1A1A] truncate pr-2"
                                title={tower.name}
                              >
                                {tower.name}
                              </h5>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-4 md:gap-y-6 lg:gap-x-20">
                  ...
                  <div className="space-y-4 md:space-y-5">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center">
                      ...
                      <span className="text-[16px] font-gantari font-medium text-[#616161]">
                        {formatDate(
                          selectedProject.due_date || selectedProject.due_date,
                        )}
                      </span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:items-center">
          ...
          <div className="flex flex-col h-full bg-white">
            <div className="relative flex items-center justify-center px-10 py-8 border-b border-slate-50">
              ...
              <div className="text-center">
                ...
                <p className="text-[14px] font-Gantari font-bold text-[#999999] mt-0.5">
                  {milestonesProject.project_name}
                </p>
              </div>
            </div>
            <div className="flex-1 flex flex-col items-center justify-center text-center p-10">
              <h4 className="text-[20px] font-Gantari font-bold text-[#353535] mb-2">
                No Payment Milestones Found
              </h4>
              <p className="text-[16px] font-Gantari font-medium text-[#666666] mb-10">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="border-t border-[#E8E8E8] pt-4 mt-auto flex items-center justify-between">
                          ...
                          <div
                            className={`px-3.5 py-1 rounded-[8px] text-white text-[13px] font-bold font-Gantari shadow-sm ${isHighPri ? "bg-[#DD4342]" : "bg-[#94D6F2]"}`}
                          >
                            {p.priority || "Normal"}
                          </div>
                        </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-4xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            <div className="p-8 md:p-10 overflow-y-auto custom-scrollbar flex-1">
              <div className="flex justify-between items-center mb-8">
                <h3 className="text-[22px] font-bold text-[#1E293B] font-sora">
                  New Project
                </h3>
                <div className="group relative">
                  <button
                    onClick={() => setShowCreateModal(false)}
                    className="p-2 hover:bg-[#F1F5F9] rounded-lg bg-[#F2F2F2] cursor-pointer"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="none"
