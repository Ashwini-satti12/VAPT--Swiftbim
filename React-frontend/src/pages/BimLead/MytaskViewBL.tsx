...
export default function MytaskViewBL() {
    ...
    {/* Center Heading */}
    <h1 className="text-center text-[20px] sm:text-[24px] font-semibold text-black">
            ...
            <div className="flex-1 min-h-0 overflow-y-auto p-6 scroll-smooth">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 border border-slate-200 rounded-xl p-6">
                    ...
                    <div className="rounded-sm bg-[#F2F7FF] p-4 h-fit">
                        ...
                        />
                        <div className="rounded-md bg-[#F2F2F2] flex flex-col items-center justify-center py-8 px-4 text-slate-500 min-h-[120px] relative transition-all duration-200">
                            {selectedImagePreview ? (
                                <>
