        ...
        <div className="flex flex-col lg:h-full lg:overflow-hidden">
            ...
            <div className="bg-white pb-6 pt-0 border-b border-transparent shrink-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                    ...
                    <Link to="/bl/teamtasks" className="bg-[#F2F2F2] group hover:bg-[#DD4342] rounded-xl border border-[#AEACAC52] px-4 py-6 shadow-sm flex items-center justify-between min-h-0 cursor-pointer no-underline">
                        ...
                        {priorityTasks.length === 0 ? (
                            ...
                            <>
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <Link to="/bl/projects" className="text-sm font-medium text-[#DE3D3A] hover:underline font-gantari cursor-pointer">View all</Link>
                                </div>
                                {(() => {
                                    ...
                                    return Array.from(byProject.entries()).map(([id, { projectName, tasks: projectTasks }]) => (
                                        <div key={id} className="mb-6">
                                            <p className="text-sm font-semibold text-[#353535] font-gantari mb-3 truncate pr-2">
                                                <Link to="/bl/projects" className="hover:text-[#DE3D3A] hover:underline cursor-pointer" title={projectName}>{projectName}</Link>
                                            </p>
